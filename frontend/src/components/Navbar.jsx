...
const Navbar = () => {
 ...
 return (
  ...
  <div className='flex items-center justify-between py-5 font-medium'>
    ...
    <Link to='/'><img src={assets.logo} className='w-36 cursor-pointer object-contain' alt="Logo" /></Link>
    ...
    <div className='flex items-center gap-6'>
     ...
     <div className='group relative'>
       ...
       <div className='group-hover:block hidden absolute dropdown-menu right-0 z-20'>
        {/* Dropdown Menu */}
        { token && 
